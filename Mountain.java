public class Mountain {
    ...
    public static int peakIndexInMountainArray(int[] arr){
        ...
        //in the end,start == end pointing to the largest number becuase of the 2 checks above
        //start and end are always trying to find max element in the above 2 checks
        //hence when they are pointing to just 1 element, this is tyhe max one because that what the checks says
